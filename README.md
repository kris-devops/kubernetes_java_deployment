...
3) Build the image in local -> docker build -t krishnakr198989/shopfront:latest .

docker build -t krishnakr198989/productcatalogue:latest .

docker build -t krishnakr198989/stockmanager:latest .

4) Push the image to your docker hub -> docker push krishnakr198989/shopfront:latest 

docker push krishnakr198989/productcatalogue:latest

docker push krishnakr198989/stockmanager:latest
